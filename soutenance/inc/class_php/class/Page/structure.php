...
class structure extends Configuration\Information {
    /**
     ...
     */
    function __construct($pStrTitre = "", $pStrEntete = "entete.php", $pStrPied = "footer.php", $pStrScript = "") {
        
        include(parent::CHEMIN_RACINE . 'inc/class_php/mep/' . $pStrEntete);
        $this->_strPied = $pStrPied;
        $this->_strScript = $pStrScript;
    }
    public function __destruct() {
        include(parent::CHEMIN_RACINE . 'inc/class_php/mep/' . $this->_strPied);
    }
}
