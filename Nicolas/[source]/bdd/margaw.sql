Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id nibh nec leo sollicitudin accumsan id eu lacus. Vestibulum tincidunt fermentum nisl ac efficitur. Nunc ullamcorper orci ac velit tristique porta. In at ex quam. Nunc rhoncus dictum orci, vitae tempus velit faucibus nec. Integer convallis convallis suscipit. Integer at nisi tempor, fringilla orci vel, varius nisi. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Proin eget faucibus magna, at iaculis leo. Phasellus volutpat sollicitudin dui eget egestas. Nulla ultricies luctus accumsan.</p>', 'esrvb', '2016-02-21 17:51:52', NULL),
(9, '<p>&nbsp;srfvdtv</p>', 'de', '2016-02-21 18:40:12', NULL),
(10, '<p>scveufyefvbseucvsyg</p>', 'toto', '2016-02-21 18:59:47', NULL),
(11, '<p>scveufyefvbseucvsyg</p>', 'toto', '2016-02-21 19:00:25', NULL),
(12, '<p>bnfyfyunfyvbiyvifgnv kntvijntub</p>', 'dbdbtbh', '2016-02-21 19:02:48', NULL),
(13, '<p>bnfyfyunfyvbiyvifgnv kntvijntub</p>', 'dbdbtbh', '2016-02-21 19:03:41', NULL),
(14, '<p>&ccedil;a marche ou pas ?</p>', 'drecks', '2016-02-21 21:46:00', NULL),
(15, '<p>fxvvx</p>', 'dgvc', '2016-02-22 17:42:34', NULL),
(16, '<p>fxvvx</p>', 'dgvc', '2016-02-22 17:43:15', NULL),
(17, '<p>titi tutu</p>', 'toto', '2016-02-29 12:05:24', NULL),
(18, '<p>c''est bon</p>\r\n<p>&nbsp;</p>', 'drecks', '2016-02-29 12:06:31', NULL);
...
CREATE TABLE IF NOT EXISTS `identification` (
  ...
  `creationidentifiant` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `derniereconnexion` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `datedenaissance` date NOT NULL,
  `email` varchar(100) NOT NULL,
  `questionsecrete` varchar(200) NOT NULL,
  `reponsesecrete` varchar(200) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `identification` (`id`, `nom`, `prenom`, `identifiant`, `motdepasse`, `creationidentifiant`, `derniereconnexion`, `datedenaissance`, `email`, `questionsecrete`, `reponsesecrete`) VALUES
(1, 'Fernette', 'Frédéric', 'Drecks', '15121984', '2016-05-15 15:33:47', NULL, '1984-12-15', 'drecks.fernette@gmail.com', 'qui êtes vous ?', 'bah moi !'),
(2, 'Fernette', 'Frédéric', 'fred', '1234', '2016-05-15 15:34:05', '2016-05-15 17:48:47', '1984-12-15', 'drecks.fernette@gmail.com', 'qui êtes vous ?', 'bah moi !');
...
(9, 'Plastitien', '2016-03-01 17:48:54', '2016-05-13 20:42:59');
