$(document).ready(function () {
    ...
    var navigation_nouvelle = new Navigation('section.nouvelle');
    var navigation_bioAuteur = new Navigation('section.bioAuteur');
    ...
    var gestion_url = new url_influence('section.refAuteur nav li > a');
